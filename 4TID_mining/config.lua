...
Config.Time					= 4 * sec      -- เวลาตอนเก็บ 10 เท่ากับ 10 วิ 
Config.TimeW				= 2 * sec      -- เวลาตอนถือบนมือ 10 เท่ากับ 10 วิ 
...
Config.itemname 			= 'dmuncut'		-- Item ที่ใช่ได้หลังจาก Process
Config.ItemCount 			= {1, 1}		-- จำนวน item ที่จะได้
Config.SpawnObjects 		= 15			-- จำนวน Objects ที่จะ Spawn
Config.stress				= false			-- หลอดความเครียด
Config.count				= 100000			-- มากน้อยแค่ไหน
Config.ItemBonus = {
	{
        ItemName = "goldbar",
        ItemCount = 1,
